...
CREATE TABLE Ventas (
    ...
    id_corte INT NOT NULL,    -- En qu� turno (Tabla Corte_Caja)
    id_dpv INT NOT NULL,
    id_cupon INT NULL,   
    ...
    -- Esto permite que la Sucursal norte tenga el folio 'N001' y la Sucursal sur TAMBI�N tenga el folio 'S001'.
...
CREATE TABLE Cupones (
    ...
    -- Si es null = V�lido en todas las tiendas.
    -- Si tiene valor = V�lido solo en esa tienda.
    ...
    valor DECIMAL(10,2) NOT NULL, -- El n�mero a descontar
    ...
    -- L�mites
    usos_maximos INT DEFAULT 100, -- Cu�ntas veces se puede canjear en total
    usos_actuales INT DEFAULT 0,  -- Contador de cu�ntas veces se ha usado ya
    ...
    -- No permite crear dos cupones con el mismo c�digo textual (Ej: 'HOLA' y 'HOLA')
    CONSTRAINT UQ_Codigo_Cupon UNIQUE (codigo),

    -- Validaci�n extra (Opcional): Que la fecha fin no sea menor a la inicio
